...
internal sealed class PostgresAuthTransactionManager : IAuthTransactionManager
{
    // Executes and commits an asynchronous PostgreSQL transaction or rolls it back safely.
