...
internal static class PostgresAuthorizationReconciliationMigration
{
    ...
    internal const string Sql = """
        CREATE TABLE auth_migration_reconciliation_reports(
            ...
            global_assignment_count bigint NOT NULL CHECK(global_assignment_count >= 0),
            tenant_assignment_count bigint NOT NULL CHECK(tenant_assignment_count >= 0),
            tenant_owner_count bigint NOT NULL CHECK(tenant_owner_count >= 0),
            ambiguous_assignment_count bigint NOT NULL CHECK(ambiguous_assignment_count >= 0)
        );
        ...
        SELECT
            '009_record_authorization_reconciliation',CURRENT_TIMESTAMP,
